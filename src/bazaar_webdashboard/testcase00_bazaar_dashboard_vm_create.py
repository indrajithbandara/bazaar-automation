...
class testcase_bazaar_dashboard_vm_create(unittest.TestCase):
    def setUp(self):
    ...
    def test_bazaar_dashboard_vm_create(self):
        driver = self.driver
...
#         driver.find_element_by_id("kw").click()
        ...
        driver.find_element_by_id("editEnterpriseEmail").send_keys("jun.cui+0714@hpetest.com")
        driver.implicitly_wait(30)
...
#         driver.find_element_by_id("$childMenu->nameStringId").click()
        ...
        driver.find_element_by_link_text(u"路由").click()
        time.sleep(2)
        driver.find_element_by_link_text("router").click()
        time.sleep(2)
        driver.find_element_by_link_text(u"路由").click()
        time.sleep(2)
