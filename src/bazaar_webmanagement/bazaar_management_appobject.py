...
#accordionZZZ > div > div:nth-child(3) > div.panel-collapse.collapse.in > div > a  
#priceManagementCollapseList
#@staticmethod  
def GetInstance():  
    instance = None  
...
conf.read("C:/BazaarCodeDeveloper/bazaarworkspace/bazaar-automation/test-config/userdata_bazaaradmin.conf")

global bazaaradminhostname,bazaaradminusername,bazaaradminpassword
bazaaradminhostname = conf.get("bazaaradminsection", "uihostname")
bazaaradminusername = conf.get("bazaaradminsection", "uiusername")
bazaaradminpassword = conf.get("bazaaradminsection", "uipassword")

print bazaaradminhostname, bazaaradminusername, bazaaradminpassword
