...
class testcase_bazaar_marketplace_tab07others(unittest.TestCase):
    def setUp(self):
    ...
    def test_bazaar_marketplace_tab07others(self):
        driver = self.driver
...
#         driver.find_element_by_id("kw").click()
        ...
        time.sleep(2)
        driver.find_element_by_css_selector("a.panelItem.active > span").click()
        time.sleep(2)
        ...
        time.sleep(2)
        driver.find_element_by_xpath("//footer/div/ul/li[2]/a/span").click()
        time.sleep(1)
